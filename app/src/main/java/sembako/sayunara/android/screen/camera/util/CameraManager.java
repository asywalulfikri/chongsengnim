...
import sembako.sayunara.android.screen.camera.CameraActivity;
...
public class CameraManager {
   ...
   /* public void processPhotoItem(Activity activity, PhotoItem photo) {
        ...
        if (ImageUtils.isSquare(photo.getImageUri())) {
            Intent newIntent = new Intent(activity, PostQuestionActivityNew.class);
            newIntent.putExtra("null","notnull");
