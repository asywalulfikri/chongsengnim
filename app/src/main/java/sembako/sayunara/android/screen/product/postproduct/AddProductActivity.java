package sembako.sayunara.android.screen.product.postproduct;
...
import sembako.sayunara.android.screen.camera.AlbumActivity;
import sembako.sayunara.android.screen.product.postproduct.adapter.PodImageAdapter;
import sembako.sayunara.android.screen.product.postproduct.model.PodImage;
import sembako.sayunara.android.screen.profile.model.User;
import sembako.sayunara.android.util.FileChooserHelper;
...
public class AddProductActivity extends BaseActivity implements View.OnClickListener,PodImageAdapter.DeletedItemListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        et_type_product   = findViewById(R.id.et_type_product);
        et_weight_product = findViewById(R.id.et_weight_product);
        et_satuan_product = findViewById(R.id.et_satuan_product);
        et_available_product = findViewById(R.id.et_available_product);
        et_price_product = findViewById(R.id.et_price_product);
        et_stock_product = findViewById(R.id.et_stock_product);
        et_description_product = findViewById(R.id.et_description_product);
    ...
    public void takeImage(){
        ...
        if(mImageListPhoto.size()>2){
            Toast.makeText(getActivity(),"Maksimal Foto 3",Toast.LENGTH_SHORT).show();
        }else {
            PopupMenu popup = new PopupMenu(getActivity(), iv_add_image);
            popup.inflate(R.menu.menu_photo_chooser);
            popup.setOnMenuItemClickListener(item -> {
                switch (item.getItemId()) {
                    case R.id.action_browse:
                        //EasyImage.openGallery(getActivity(), PICK_IMAGE);
                        Intent newIntent = new Intent(getActivity(), AlbumActivity.class);
    ...
    private void satuandialog() {
        final String[] type = {"Kg","Ons","Kwintal","Gram","Ml","Pon","Pack","Bungkus"};
