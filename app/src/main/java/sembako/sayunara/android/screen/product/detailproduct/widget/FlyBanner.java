package sembako.sayunara.android.screen.product.detailproduct.widget;
...
public class FlyBanner extends RelativeLayout {
    ...
    private void setLayout(Context context) {
        ...
        //添加ViewPager
        mViewPager = new WrapContentViewPager(context);
    ...
    private WrapContentViewPager.OnPageChangeListener mOnPageChangeListener = new WrapContentViewPager.OnPageChangeListener() {
        @Override
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LWC2, LWC2);
