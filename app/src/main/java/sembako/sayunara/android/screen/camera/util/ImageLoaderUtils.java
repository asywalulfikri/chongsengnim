...
public class ImageLoaderUtils {
    ...
    public static void displayLocalImage1(String uri, ImageView imageView, DisplayImageOptions options) {
        ImageLoader.getInstance().displayImage(uri, new ImageViewAware(imageView), options, null, null);
    }
