...
class RoundTabLayout : HorizontalScrollView, ViewPager.OnPageChangeListener {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        val typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.RoundTabLayoutx)
        tabStrokeColor = typedArray.getColor(R.styleable.RoundTabLayoutx_accent, 0xff464646.toInt())
        cornerRadius = typedArray.getInt(R.styleable.RoundTabLayoutx_cornerRadiuss, 50)
        hasStroke = typedArray.getBoolean(R.styleable.RoundTabLayoutx_withStroke, true)
        iconRes = typedArray.getDrawable(R.styleable.RoundTabLayoutx_src)
        typedArray.recycle()
