package sembako.sayunara.android.ui.component.mainmenu.banner.component;
...
public class ViewPagerIndicator extends View {
    ...
    protected void onDraw(Canvas canvas) {
      ...
      /*  int flags = Canvas.MATRIX_SAVE_FLAG | Canvas.CLIP_SAVE_FLAG | Canvas.HAS_ALPHA_LAYER_SAVE_FLAG | Canvas.FULL_COLOR_LAYER_SAVE_FLAG | Canvas
        ...
        int flags = Canvas.ALL_SAVE_FLAG | Canvas.ALL_SAVE_FLAG | Canvas.ALL_SAVE_FLAG | Canvas.ALL_SAVE_FLAG | Canvas
                .ALL_SAVE_FLAG;
