...
public class BlurBehind {
    ...
    public void execute(AppCompatActivity activity, OnBlurCompleteListener onBlurCompleteListener) {
    ...
    public void setBackground(AppCompatActivity activity) {
    ...
    private class CacheBlurBehindAndExecuteTask extends AsyncTask<Void, Void, Void> {
        ...
        public CacheBlurBehindAndExecuteTask(AppCompatActivity activity, OnBlurCompleteListener onBlurCompleteListener) {
